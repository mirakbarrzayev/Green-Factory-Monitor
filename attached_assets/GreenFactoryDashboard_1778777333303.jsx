...
const styles = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .section-grid-3 { display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 16px; }
  .panel {
  ...
  .gauge-val { font-family: var(--font-head); font-size: 22px; font-weight: 800; color: var(--text); text-align: center; line-height: 1; }
  .gauge-lbl { font-size: 11px; color: var(--text3); text-align: center; margin-top: 2px; }
  ...
  /* WATER METER */
  .water-meter { position: relative; width: 100%; height: 120px; }
  .water-fill {
  ...
  .alert-banner {
    ...
    border-radius: var(--r2); margin-bottom: 16px; animation: slideIn 0.3s ease;
  }
  ...
  .empty-page {
    ...
    height: 400px; color: var(--text3); gap: 16px;
  }
  .empty-page-icon { width: 64px; height: 64px; opacity: 0.3; }
...
function AuthScreen({ onLogin }) {
  ...
  const handleSignIn = () => {
    ...
    setTimeout(() => {
      setLoading(false);
      onLogin({ name: signIn.email.split("@")[0], email: signIn.email });
    }, 1000);
  };

  const upd = (field, val) => { setSignUp(p => ({...p, [field]: val})); setErrors(p => ({...p, [field]: ""})); };
  const updIn = (field, val) => { setSignIn(p => ({...p, [field]: val})); setErrors(p => ({...p, [field]: ""})); };
    ...
    <div className="onboard-wrap">
      <div className="onboard-left">
        ...
        <p className="onboard-sub">
          Sənaye müəssisənizin enerji, su və karbon göstəricilərini real vaxt rejimində izləyin. Kiber-təhlükəsizlik auditi ilə tam qorunma.
        </p>
      ...
      <div className="onboard-right">
        <div className="auth-box">
          <div className="tab-switcher">
            <button className={`tab-btn ${tab === "signin" ? "active" : ""}`} onClick={() => { setTab("signin"); setErrors({}); }}>Daxil ol</button>
            <button className={`tab-btn ${tab === "signup" ? "active" : ""}`} onClick={() => { setTab("signup"); setErrors({}); }}>Qeydiyyat</button>
          </div>
          ...
          {tab === "signin" ? (
            <div className="page">
              ...
              <div className="form-group">
                ...
                <div className="input-wrap">
                  ...
                  <input className={`form-input ${errors.email?"err":""}`} type="email" placeholder="adınız@email.com"
                    value={signIn.email} onChange={e=>updIn("email",e.target.value)}/>
                </div>
              ...
              <div className="form-group">
                ...
                <div className="input-wrap">
                  ...
                  <input className={`form-input ${errors.password?"err":""}`} type={showPw?"text":"password"} placeholder="Şifrənizi daxil edin"
                    value={signIn.password} onChange={e=>updIn("password",e.target.value)}/>
            ...
            <div className="page">
              ...
              <div className="form-row">
                <div className="form-group">
                  ...
                  <div className="input-wrap">
                    ...
                    <input className={`form-input ${errors.firstName?"err":""}`} placeholder="Adınız"
                      value={signUp.firstName} onChange={e=>upd("firstName",e.target.value)}/>
                  </div>
                ...
                <div className="form-group">
                  ...
                  <div className="input-wrap">
                    <span className="input-icon"><IconUser/></span>
                    <input className={`form-input ${errors.lastName?"err":""}`} placeholder="Soyadınız"
                      value={signUp.lastName} onChange={e=>upd("lastName",e.target.value)}/>
                  </div>
              ...
              <div className="form-group">
                ...
                <div className="input-wrap">
                  <span className="input-icon"><IconMail/></span>
                  <input className={`form-input ${errors.email?"err":""}`} type="email" placeholder="adınız@gmail.com"
                    value={signUp.email} onChange={e=>upd("email",e.target.value)}/>
                </div>
                {errors.email && <div className="err-msg">{errors.email}</div>}
              </div>
              <div className="form-group">
                ...
                <div className="input-wrap">
                  <span className="input-icon"><IconLock/></span>
                  <input className={`form-input ${errors.password?"err":""}`} type={showPw?"text":"password"} placeholder="Şifrə yaradın"
                    value={signUp.password} onChange={e=>upd("password",e.target.value)}/>
                  <button className="eye-btn" onClick={()=>setShowPw(p=>!p)}><IconEye off={showPw}/></button>
                </div>
                {errors.password && <div className="err-msg">{errors.password}</div>}
              ...
              <div className="form-group">
                ...
                <div className="input-wrap">
                  <span className="input-icon"><IconLock/></span>
                  <input className={`form-input ${errors.confirm?"err":""}`} type={showPw2?"text":"password"} placeholder="Şifrəni təkrar daxil edin"
                    value={signUp.confirm} onChange={e=>upd("confirm",e.target.value)}/>
...
function Dashboard({ user, onLogout }) {
  ...
  const [sensor, setSensor] = useState(generateSensorData());
  ...
  const navItems = [
    { id: "overview", label: "İcmal", icon: <IconFactory/> },
    { id: "energy", label: "Enerji Sərfiyyatı", icon: <IconZap/> },
    { id: "water", label: "Su Sərfiyyatı", icon: <IconDroplets/> },
    { id: "emissions", label: "Karbon Emissiyası", icon: <IconWind/> },
    { id: "reports", label: "Hesabatlar", icon: <IconBarChart/> },
  ];
  ...
  const highTemp = sensor.energy > 80;
      ...
      <main className="dash-main">
          ...
          <div className="page">
            ...
            {highTemp && (
              <div className="alert-banner">
                ...
                <div className="alert-text">⚠️ Enerji sərfiyyatı kritik həddə çatıb: {sensor.energy} kWh — Dərhal yoxlayın</div>
              </div>
            )}
            ...
            <div className="kpi-grid">
              ...
              <div className="kpi-card water">
                ...
                <div className="kpi-value">{sensor.water}</div>
              ...
              <div className="kpi-card co2">
                ...
                <div className="kpi-value">{sensor.co2}</div>
            ...
            <div className="section-grid-3">
              <div className="panel">
                <div className="panel-header">
                  <div className="panel-title">Enerji Histoqramı</div>
                </div>
              ...
              <div className="panel">
                <div className="panel-header">
                  <div className="panel-title">CO₂ Trendi</div>
                </div>
              ...
              <div className="panel">
                <div className="panel-header">
                  <div className="panel-title">Su Trendi</div>
                </div>
                <div className="line-chart-wrap" style={{height:100}}>
        ...
        {activePage === "energy" && (
          <div className="page">
            ...
            {highTemp && <div className="alert-banner"><div className="alert-dot"/><div className="alert-text">Kritik enerji sərfiyyatı aşkarlandı: {sensor.energy} kWh</div></div>}
        ...
        {activePage === "water" && (
          <div className="page">
            ...
            <div className="kpi-grid" style={{gridTemplateColumns:"repeat(3,1fr)",marginBottom:24}}>
              <div className="kpi-card water">
                <div className="kpi-header"><div className="kpi-icon water"><IconDroplets/></div></div>
                <div className="kpi-value">{sensor.water}</div>
                <div className="kpi-unit">Litr — Cari</div>
              </div>
              <div className="kpi-card water">
                <div className="kpi-header"><div className="kpi-icon water"><IconDroplets/></div></div>
                <div className="kpi-value">{(waterHistory.reduce((a,b)=>a+b,0)/waterHistory.length||0).toFixed(1)}</div>
                <div className="kpi-unit">Litr — Ortalama</div>
              </div>
              <div className="kpi-card water">
                <div className="kpi-header"><div className="kpi-icon water"><IconDroplets/></div></div>
                <div className="kpi-value">{Math.max(...waterHistory).toFixed(1)}</div>
                <div className="kpi-unit">Litr — Pik</div>
              </div>
            </div>
            <div className="section-grid">
              <div className="panel">
        ...
        {activePage === "emissions" && (
          <div className="page">
            ...
            <div className="kpi-grid" style={{gridTemplateColumns:"repeat(3,1fr)",marginBottom:24}}>
              <div className="kpi-card co2">
                <div className="kpi-header"><div className="kpi-icon co2"><IconWind/></div></div>
                <div className="kpi-value">{sensor.co2}</div>
                <div className="kpi-unit">kg CO₂ — Cari</div>
              </div>
              <div className="kpi-card co2">
                <div className="kpi-header"><div className="kpi-icon co2"><IconWind/></div></div>
                <div className="kpi-value">{(co2History.reduce((a,b)=>a+b,0)/co2History.length||0).toFixed(2)}</div>
                <div className="kpi-unit">kg CO₂ — Ortalama</div>
              </div>
              <div className="kpi-card co2">
                <div className="kpi-header"><div className="kpi-icon co2"><IconWind/></div></div>
                <div className="kpi-value">{co2History.reduce((a,b)=>a+b,0).toFixed(1)}</div>
                <div className="kpi-unit">kg CO₂ — Ümumi</div>
              </div>
            </div>
            <div className="panel">
          ...
          <div className="page">
            ...
            <div className="section-grid">
              <div className="panel">
                ...
                {[
                  {title:"Aylıq Enerji Hesabatı",date:"May 2025",status:"rb-ok",statusTxt:"Hazır",icon:"energy"},
                  {title:"Su Sərfiyyatı Analizi",date:"Apr 2025",status:"rb-ok",statusTxt:"Hazır",icon:"water"},
                  {title:"CO₂ Emissiya Hesabatı",date:"May 2025",status:"rb-warn",statusTxt:"İşlənir",icon:"co2"},
                  {title:"Kiber-Audit Protokolu",date:"May 2025",status:"rb-ok",statusTxt:"Hazır",icon:"score"},
                  {title:"Həftəlik İcmal",date:"Bu həftə",status:"rb-crit",statusTxt:"Kritik",icon:"energy"},
                ].map((r,i)=>(
                  <div className="report-item" key={i}>
                    <div className={`report-icon kpi-icon ${r.icon}`} style={{width:36,height:36}}>
                      {r.icon==="energy"?<IconZap/>:r.icon==="water"?<IconDroplets/>:r.icon==="co2"?<IconWind/>:<IconLeaf/>}
                    </div>
                    <div>
              ...
              <div className="panel">
                <div className="panel-header"><div className="panel-title">Xülasə Statistikası</div></div>
                <div style={{display:"flex",flexDirection:"column",gap:16}}>
                  {[
                    {label:"Enerji Effektivliyi",val:"78%",color:"var(--amber)"},
                    {label:"Su Qənaəti",val:"63%",color:"var(--blue)"},
                    {label:"CO₂ Azalma",val:"41%",color:"var(--green)"},
                    {label:"Sistem Etibarlılığı",val:"99.2%",color:"var(--teal)"},
                  ].map((s,i)=>(
                    <div key={i}>
